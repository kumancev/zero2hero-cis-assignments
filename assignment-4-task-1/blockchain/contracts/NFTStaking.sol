...
contract NFTStaking is ReentrancyGuard {
    ...
    constructor(IERC20 _rewardsToken, IERC721 _nftCollection) {
    ...
    uint256 private rewardsPerHour = 100_000;
    ...
    function avaibleRewards(address _staker) public view returns (uint256) {
