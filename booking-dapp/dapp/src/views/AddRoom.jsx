        ...
        <form className="flex flex-col" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-row justify-between items-center border border-gray-300 p-2 rounded-xl mt-5">
            <input
              ...
              type="url"
              name="images"
              placeholder="Upload up to 5 photos"
            ...
            {links.length != 5 ? (
              <button
                onClick={addImage}
                type="button"
                className="p-2 bg-[#0e76fd] text-white rounded-full text-sm"
              >
                Add image link
              </button>
            ) : null}
          ...
          <button
            ...
            className="flex flex-row justify-center items-center
              w-full text-white text-md bg-[#0e76fd]
              py-2 px-5 rounded-full drop-shadow-xl hover:bg-white
              border-transparent
              hover:hover:text-[#0e76fd]
              hover:border-2 hover:border-[#0e76fd]
              mt-5"
          >
            Add Appartment
          </button>
