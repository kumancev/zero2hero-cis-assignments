...
const AuthModal = () => {
  ...
  return (
    ...
    >
      <div
        className="bg-white shadow-xl shadow-[#0e76dd] rounded-xl
        ...
        <div className="flex flex-col">
          ...
          <div className="flex justify-start items-center space-x-2 mt-5">
            <button
              ...
              className="bg-[#0e76fd] p-2 px-6 rounded-full text-white shadow-md
            ...
            <button
              onClick={handleLogin}
              className="border border-[#0e76fd] text-[#0e76fd] p-2 px-6 rounded-full shadow-md
              shadow-gray-300 transform transition-transform duration-30 w-fit"
            >
              Login
            </button>
