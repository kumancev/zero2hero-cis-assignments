...
contract VotingDAO is ReentrancyGuard, AccessControl {
    bytes32 private immutable CONTRIBUTOR_ROLE = keccak256("CONTRIBUTOR");
    bytes32 private immutable STAKEHOLDER_ROLE = keccak256("STAKEHOLDER");
    uint256 immutable MIN_STAKEHOLDER_CONTRIBUTION = 0.05 ether;
    uint32 immutable MIN_VOTE_DURATION = 10 minutes;  // 600 or 10*60
    ...
    function createProposal(
     ...
     stakeholderOnly("Proposal Creation Allowed forr Stakeholders only")
